<template>
  <div class="playing-card cursor-pointer">
    <div class="flip-card cursor-pointer transition-transform duration-200 hover:scale-105 active:scale-95" :class="{ 'flip-card--active cursor-auto': pokemon.visible }" @click="selectPokemon(pokemon)">
