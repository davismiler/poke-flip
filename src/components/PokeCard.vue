<template>
  <div class="playing-card cursor-pointer">
    <div class="flip-card cursor-pointer" :class="{ 'flip-card--active cursor-auto': pokemon.visible }" @click="selectPokemon(pokemon)">
      ...
      <!--  -->
      <div class="card-back p-5 flex justify-center items-center bg-secondary/50 border border-primary/50">
        <svg class="text-muted-foreground/40" viewBox="0 0 87 87" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g opacity="0.3">
            <path
              opacity="0.3"
